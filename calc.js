...
const equipment_level_preset = {1:10, 2:20, 3:30, 4:40, 5:45, 6:50, 7:55, 8:60, 9:65};
...
'hat' : {
	//	param		  	   N	T1		T2		T3		T4		T5		T6		T7		T8		T9
		'attack%' 		: [0,	8, 		13,		18,		25,		30,		35,		40, 	45,		48	],
		'crit_damage' 	: [0,	0, 		0, 		0,		800, 	1200,	1600,	1800, 	2000,	2000],
	},

'gloves' : {
	//	param			   N	T1		T2		T3		T4		T5		T6		T7		T8		T9
		'attack%'		: [0,	6.4, 	10.4,	14.4,	20,		25,		30,		35,		40,		46	],
		'crit_rate'	 	: [0,	0, 		0, 		0,		70,		200,	300,	350,	370,	450	],
		'accuracy' 		: [0,	0, 		0, 		0,		0, 		0,		30,		200,	220,	220	],
	},

'shoes' : {
	//	param			   N	T1		T2		T3		T4		T5		T6		T7		T8		T9
		'attack%'		: [0,	4, 		6.5,	9,		12.5,	20,		25,		30, 	35,		42	],
		'hp%'			: [0,	0, 		0, 		0,		6, 		9,		12,		13.5,	15,		17.5],
	},
...
'badge' : {
	//	param			   N	T1		T2		T3		T4		T5		T6		T7		T8		T9
		...
		'evasion'		: [0,	0, 		0, 		0,		0,	 	0,		0,		400,	450,	450	],
	},
